...
ppEnergytext = ROOT.TLatex(0.19, 0.81, "pp, #sqrt{#it{s}} = 13.6 Te#kern[-0.05]{V}")
ppEnergytext.SetNDC()
...
textPt = ROOT.TLatex(0.19, 0.605, '2.0 < #it{p}_{T} < 2.5 Ge#kern[-0.05]{V}/#it{c}')
textPt.SetNDC()
...
hFrame = padFit.cd().DrawFrame(1.75, 0.1, 2.1, 3000, ";#it{M}(KK#pi) (Ge#kern[-0.05]{V}/#it{c}^{2});Counts per 2 Me#kern[-0.05]{V}/#it{c}^{2}")
...
hFrameRes = padRes.cd().DrawFrame(1.75, -300., 2.1, 1750, ";#it{M}(KK#pi) (Ge#kern[-0.05]{V}/#it{c}^{2});Data - Bkg. fit")
hFrameRes.GetXaxis().SetTitleOffset(1)
hFrameRes.GetYaxis().SetTitleOffset(0.57)
hFrameRes.GetXaxis().SetTitleSize(0.125)
hFrameRes.GetYaxis().SetTitleSize(0.12)
...
DsMeanText = ROOT.TLatex(0.68, 0.77, f"#it{{#mu}} = ({hRawYieldsMean.GetBinContent(hRawYieldsMean.FindBin(2.01))*1000:.1f} #pm {hRawYieldsMean.GetBinError(hRawYieldsMean.FindBin(2.01))*1000:.1f}) Me#kern[-0.05]{{V}}/#it{{c}}^{{2}}")
DsMeanText.SetNDC()
DsMeanText.SetTextSize(0.07)
DsSigmaText = ROOT.TLatex(0.68, 0.68, f"#it{{#sigma}} = ({hRawYieldsSigma.GetBinContent(hRawYieldsSigma.FindBin(2.01))*1000:.1f} #pm {hRawYieldsSigma.GetBinError(hRawYieldsSigma.FindBin(2.01))*1000:.1f}) Me#kern[-0.05]{{V}}/#it{{c}}^{{2}}")
DsSigmaText.SetNDC()
...
DplusMeanText = ROOT.TLatex(0.17, 0.77, f"#it{{#mu}} = ({hRawYieldsMeanSecondPeak.GetBinContent(hRawYieldsMeanSecondPeak.FindBin(2.01))*1000:.1f} #pm {hRawYieldsMeanSecondPeak.GetBinError(hRawYieldsMeanSecondPeak.FindBin(2.01))*1000:.1f}) Me#kern[-0.05]{{V}}/#it{{c}}^{{2}}")
DplusMeanText.SetNDC()
DplusMeanText.SetTextSize(0.07)
DplusSigmaText = ROOT.TLatex(0.17, 0.68, f"#it{{#sigma}} = ({hRawYieldsSigmaSecondPeak.GetBinContent(hRawYieldsSigmaSecondPeak.FindBin(2.01))*1000:.1f} #pm {hRawYieldsSigmaSecondPeak.GetBinError(hRawYieldsSigmaSecondPeak.FindBin(2.01))*1000:.1f}) Me#kern[-0.05]{{V}}/#it{{c}}^{{2}}")
...
hFrame = padFit.cd().DrawFrame(1.75, 0.1, 2.15, 1250, ";#it{M}(KK#pi) (Ge#kern[-0.05]{V}/#it{c}^{2});Counts per 2 Me#kern[-0.05]{V}/#it{c}^{2}")
hFrame.GetXaxis().SetTitleOffset(1.)
hFrame.GetYaxis().SetTitleOffset(1.4)
hFrame.GetXaxis().SetTitleSize(0.05)
hFrame.GetYaxis().SetTitleSize(0.05)
...
hFrameRes = padRes.cd().DrawFrame(1.75, -150., 2.15, 650, ";#it{M}(KK#pi) (Ge#kern[-0.05]{V}/#it{c}^{2});Data - Bkg. fit")
hFrameRes.GetXaxis().SetTitleOffset(1)
hFrameRes.GetYaxis().SetTitleOffset(0.57)
hFrameRes.GetXaxis().SetTitleSize(0.125)
hFrameRes.GetYaxis().SetTitleSize(0.12)

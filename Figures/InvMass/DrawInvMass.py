...
hTotal_func2_2p5.SetLineColor(ROOT.kBlue)
...
rapiditytext = ROOT.TLatex(0.19, 0.75, "|y| < 0.5")
rapiditytext.SetNDC()
rapiditytext.SetTextSize(0.05)
rapiditytext.SetTextFont(42)

textPt = ROOT.TLatex(0.19, 0.675, '2.0 < #it{p}_{T} < 2.5 GeV/#it{c}')
textPt.SetNDC()
textPt.SetTextFont(42)
textPt.SetTextSize(0.05)

textDsDecay = ROOT.TLatex(0.19, 0.6, 'D_{s}^{+}, D^{+}#rightarrow #phi#pi^{+}#rightarrow K^{+}K^{#font[122]{-}}#pi^{+} ')
textDsDecay.SetNDC()
textDsDecay.SetTextFont(42)
textDsDecay.SetTextSize(0.05)


textDsDecayConj = ROOT.TLatex(0.19, 0.55, 'and charge conj.')
...
hFrame = padFit.cd().DrawFrame(1.75, 0.1, 2.1, 3000, ";#it{M}(KK#pi) (GeV/#it{c}^{2});Counts / 2.0 MeV/#it{c}^{2}")
...
legend = ROOT.TLegend(0.6, 0.6, 0.9, 0.92)
...
legend.AddEntry(hBkg1_2_2p5, "#splitline{#lower[0.1]{Combinatorial}}{#lower[-0.1]{background}}", "l")
legend.AddEntry(hBkg0_2_2p5, "D^{+}#rightarrow#piK#pi background", "l")
...
hFrameRes = padRes.cd().DrawFrame(1.75, -300., 2.1, 1750, ";#it{M}(KK#pi) (GeV/#it{c}^{2});Residuals")
hFrameRes.GetXaxis().SetTitleOffset(1.2)
hFrameRes.GetYaxis().SetTitleOffset(0.65)
hFrameRes.GetXaxis().SetTitleSize(0.1)
hFrameRes.GetYaxis().SetTitleSize(0.1)
hFrameRes.GetXaxis().SetLabelSize(0.08)
hFrameRes.GetYaxis().SetLabelSize(0.08)
...
DsmesonText.SetNDC()
DsmesonText.SetTextSize(0.09)
DsMeanText = ROOT.TLatex(0.68, 0.8, f"#mu = ({hRawYieldsMean.GetBinContent(hRawYieldsMean.FindBin(2.01))*1000:.1f} #pm {hRawYieldsMean.GetBinError(hRawYieldsMean.FindBin(2.01))*1000:.1f}) MeV/#it{{c}}^{{2}}")
DsMeanText.SetNDC()
DsMeanText.SetTextSize(0.07)
DsSigmaText = ROOT.TLatex(0.68, 0.73, f"#sigma = ({hRawYieldsSigma.GetBinContent(hRawYieldsSigma.FindBin(2.01))*1000:.1f} #pm {hRawYieldsSigma.GetBinError(hRawYieldsSigma.FindBin(2.01))*1000:.1f}) MeV/#it{{c}}^{{2}}")
DsSigmaText.SetNDC()
DsSigmaText.SetTextSize(0.07)
DsSignalText = ROOT.TLatex(0.68, 0.66, f"S = {hRawYields.GetBinContent(hRawYields.FindBin(2.01)):.0f} #pm {hRawYields.GetBinError(hRawYields.FindBin(2.01)):.0f}")
DsSignalText.SetNDC()
DsSignalText.SetTextSize(0.07)
DsBkgText = ROOT.TLatex(0.68, 0.59, f"Bkg = {hBkg.GetBinContent(hBkg.FindBin(2.01)):.0f} #pm {hBkg.GetBinError(hBkg.FindBin(2.01)):.0f}")
DsBkgText.SetNDC()
DsBkgText.SetTextSize(0.07)

DplusmesonText = ROOT.TLatex(0.17, 0.87, "D^{+} meson")
DplusmesonText.SetNDC()
DplusmesonText.SetTextSize(0.09)
DplusMeanText = ROOT.TLatex(0.17, 0.8, f"#mu = ({hRawYieldsMeanSecondPeak.GetBinContent(hRawYieldsMeanSecondPeak.FindBin(2.01))*1000:.1f} #pm {hRawYieldsMeanSecondPeak.GetBinError(hRawYieldsMeanSecondPeak.FindBin(2.01))*1000:.1f}) MeV/#it{{c}}^{{2}}")
DplusMeanText.SetNDC()
DplusMeanText.SetTextSize(0.07)
DplusSigmaText = ROOT.TLatex(0.17, 0.73, f"#sigma = ({hRawYieldsSigmaSecondPeak.GetBinContent(hRawYieldsSigmaSecondPeak.FindBin(2.01))*1000:.1f} #pm {hRawYieldsSigmaSecondPeak.GetBinError(hRawYieldsSigmaSecondPeak.FindBin(2.01))*1000:.1f}) MeV/#it{{c}}^{{2}}")
DplusSigmaText.SetNDC()
DplusSigmaText.SetTextSize(0.07)
DplusSignalText = ROOT.TLatex(0.17, 0.66, f"S = {hRawYieldsSecondPeak.GetBinContent(hRawYieldsSecondPeak.FindBin(2.01)):.0f} #pm {hRawYieldsSecondPeak.GetBinError(hRawYieldsSecondPeak.FindBin(2.01)):.0f}")
DplusSignalText.SetNDC()
DplusSignalText.SetTextSize(0.07)
DplusBkgText = ROOT.TLatex(0.17, 0.59, f"Bkg = {hBkgSecondPeak.GetBinContent(hBkgSecondPeak.FindBin(2.01)):.0f} #pm {hBkgSecondPeak.GetBinError(hBkgSecondPeak.FindBin(2.01)):.0f}")
DplusBkgText.SetNDC()
DplusBkgText.SetTextSize(0.07)
...
hTotal_func5_5p5.SetLineColor(ROOT.kBlue)
...
textPt = ROOT.TLatex(0.19, 0.675, '5.0 < #it{p}_{T} < 5.5 GeV/#it{c}')
textPt.SetNDC()
textPt.SetTextFont(42)
textPt.SetTextSize(0.05)
...
hFrame = padFit.cd().DrawFrame(1.75, 0.1, 2.15, 1250, ";#it{M}(KK#pi) (GeV/#it{c}^{2});Counts / 2.0 MeV/#it{c}^{2}")
hFrame.GetXaxis().SetTitleOffset(1.)
hFrame.GetYaxis().SetTitleOffset(1.7)
hFrame.GetXaxis().SetTitleSize(0.04)
hFrame.GetYaxis().SetTitleSize(0.04)
...
legend.AddEntry(hBkg1_5_5p5, "#splitline{#lower[0.1]{Combinatorial}}{#lower[-0.1]{background}}", "l")
legend.AddEntry(hBkg0_5_5p5, "D^{+}#rightarrow#piK#pi background", "l")
...
hFrameRes = padRes.cd().DrawFrame(1.75, -150., 2.15, 650, ";#it{M}(KK#pi) (GeV/#it{c}^{2});Residuals")
hFrameRes.GetXaxis().SetTitleOffset(1.2)
hFrameRes.GetYaxis().SetTitleOffset(0.65)
hFrameRes.GetXaxis().SetTitleSize(0.1)
hFrameRes.GetYaxis().SetTitleSize(0.1)
...
DsmesonText.SetNDC()
DsmesonText.SetTextSize(0.09)
DsMeanText = ROOT.TLatex(0.68, 0.8, f"#mu = ({hRawYieldsMean.GetBinContent(hRawYieldsMean.FindBin(5.01))*1000:.1f} #pm {hRawYieldsMean.GetBinError(hRawYieldsMean.FindBin(5.01))*1000:.1f}) MeV/#it{{c}}^{{2}}")
DsMeanText.SetNDC()
DsMeanText.SetTextSize(0.07)
DsSigmaText = ROOT.TLatex(0.68, 0.73, f"#sigma = ({hRawYieldsSigma.GetBinContent(hRawYieldsSigma.FindBin(5.01))*1000:.1f} #pm {hRawYieldsSigma.GetBinError(hRawYieldsSigma.FindBin(5.01))*1000:.1f}) MeV/#it{{c}}^{{2}}")
DsSigmaText.SetNDC()
DsSigmaText.SetTextSize(0.07)
DsSignalText = ROOT.TLatex(0.68, 0.66, f"S = {hRawYields.GetBinContent(hRawYields.FindBin(5.01)):.0f} #pm {hRawYields.GetBinError(hRawYields.FindBin(5.01)):.0f}")
DsSignalText.SetNDC()
DsSignalText.SetTextSize(0.07)
DsBkgText = ROOT.TLatex(0.68, 0.59, f"Bkg = {hBkg.GetBinContent(hBkg.FindBin(5.01)):.0f} #pm {hBkg.GetBinError(hBkg.FindBin(5.01)):.0f}")
DsBkgText.SetNDC()
DsBkgText.SetTextSize(0.07)
...
DplusmesonText.SetNDC()
DplusmesonText.SetTextSize(0.09)
DplusMeanText = ROOT.TLatex(0.17, 0.8, f"#mu = ({hRawYieldsMeanSecondPeak.GetBinContent(hRawYieldsMeanSecondPeak.FindBin(5.01))*1000:.1f} #pm {hRawYieldsMeanSecondPeak.GetBinError(hRawYieldsMeanSecondPeak.FindBin(5.01))*1000:.1f}) MeV/#it{{c}}^{{2}}")
DplusMeanText.SetNDC()
DplusMeanText.SetTextSize(0.07)
DplusSigmaText = ROOT.TLatex(0.17, 0.73, f"#sigma = ({hRawYieldsSigmaSecondPeak.GetBinContent(hRawYieldsSigmaSecondPeak.FindBin(5.01))*1000:.1f} #pm {hRawYieldsSigmaSecondPeak.GetBinError(hRawYieldsSigmaSecondPeak.FindBin(5.01))*1000:.1f}) MeV/#it{{c}}^{{2}}")
DplusSigmaText.SetNDC()
DplusSigmaText.SetTextSize(0.07)
DplusSignalText = ROOT.TLatex(0.17, 0.66, f"S = {hRawYieldsSecondPeak.GetBinContent(hRawYieldsSecondPeak.FindBin(5.01)):.0f} #pm {hRawYieldsSecondPeak.GetBinError(hRawYieldsSecondPeak.FindBin(5.01)):.0f}")
DplusSignalText.SetNDC()
DplusSignalText.SetTextSize(0.07)
DplusBkgText = ROOT.TLatex(0.17, 0.59, f"Bkg = {hBkgSecondPeak.GetBinContent(hBkgSecondPeak.FindBin(5.01)):.0f} #pm {hBkgSecondPeak.GetBinError(hBkgSecondPeak.FindBin(5.01)):.0f}")
DplusBkgText.SetNDC()
DplusBkgText.SetTextSize(0.07)

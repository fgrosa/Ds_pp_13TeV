...
hFrame = canvas.DrawFrame(0, 0, 24, 1., ';#it{p}_{T} (GeV/#it{c});D_{s}^{+}/D^{+}')
...
texty = ROOT.TLatex(0.155, 0.79, '#sqrt{s} = 13.6 Te#kern[-0.05]{V}')
texty.SetNDC()
...
textEnergy = ROOT.TLatex(0.155, 0.85, '#sqrt{s} = 13.6 Te#kern[-0.05]{V}')
textEnergy.SetNDC()
...
LegLHCbText = ROOT.TLatex(0.25, 0.23, 'LHCb, #sqrt{s} = 13 Te#kern[-0.05]{V}, JHEP03(2016)159')
LegLHCbText.SetNDC()

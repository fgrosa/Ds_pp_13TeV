...
textDsDecay = ROOT.TLatex(0.65, 0.84, 'D_{s}^{+}#rightarrow #phi#pi^{+}#rightarrow K^{+}K^{#font[122]{-}}#pi^{+} ')
textDsDecay.SetNDC()
textDsDecay.SetTextFont(42)
textDsDecay.SetTextSize(0.035)
textDsDecay.Draw()

textDsDecayConj = ROOT.TLatex(0.65, 0.8, 'and charge conj.')
textDsDecayConj.SetNDC()
textDsDecayConj.SetTextFont(42)
textDsDecayConj.SetTextSize(0.035)
textDsDecayConj.Draw()

textEnergy = ROOT.TLatex(0.155, 0.855, '#sqrt{s} = 13.6 TeV')
textEnergy.SetNDC()
textEnergy.SetTextFont(42)
textEnergy.SetTextSize(0.035)
textEnergy.Draw()

textDecay = ROOT.TLatex(0.155, 0.79, 'D^{+}#rightarrow #phi#pi^{+}#rightarrow K^{+}K^{#font[122]{-}}#pi^{+} ')
textDecay.SetNDC()
textDecay.SetTextFont(42)
textDecay.SetTextSize(0.035)
textDecay.Draw()

textDecayConj = ROOT.TLatex(0.155, 0.75, 'and charge conj.')
textDecayConj.SetNDC()
textDecayConj.SetTextFont(42)
textDecayConj.SetTextSize(0.035)
textDecayConj.Draw()

textBR = ROOT.TLatex(0.155, 0.705, 'BR unc. (not shown):{}^{#lower[5]{+3.7}}_{#lower[-0.2]{#font[122]{-}4.0}}#it{%} ')
textBR.SetNDC()
textBR.SetTextFont(42)
textBR.SetTextSize(0.03)
textBR.Draw()

Thislegend = ROOT.TLegend(0.155, 0.645, 0.355, 0.695)
...
ThislegendBorder = ROOT.TLegend(0.155, 0.645, 0.355, 0.695)

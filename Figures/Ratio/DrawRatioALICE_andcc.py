...
hFrame = canvas.DrawFrame(0, 0, 36, 1.1, ';#it{p}_{T} (GeV/#it{c});D_{s}^{+}/D^{+}')
...
textDsDecay = ROOT.TLatex(0.155, 0.74, 'D_{s}^{+}#rightarrow #phi#pi^{+}#rightarrow K^{+}K^{#font[122]{-}}#pi^{+} and c.c.')
textDsDecay.SetNDC()
...
textDecay = ROOT.TLatex(0.155, 0.68, 'D^{+}#rightarrow #phi#pi^{+}#rightarrow K^{+}K^{#font[122]{-}}#pi^{+} and c.c.')
textDecay.SetNDC()
textDecay.SetTextFont(42)
textDecay.SetTextSize(0.035)
textDecay.Draw()

textDecayConj = ROOT.TLatex(0.155, 0.86, 'and charge conj.')
textDecayConj.SetNDC()
textDecayConj.SetTextFont(42)
textDecayConj.SetTextSize(0.035)
#textDecayConj.Draw()

textBR = ROOT.TLatex(0.155, 0.64, 'BR unc. (not shown): ^{#lower[5]{+3.7}}_{#lower[-0.2]{#font[122]{-}4.0}}#it{%} ')
textBR.SetNDC()
textBR.SetTextFont(42)
textBR.SetTextSize(0.03)
textBR.Draw()

Thislegend = ROOT.TLegend(0.155, 0.58, 0.355, 0.62)
...
ThislegendBorder = ROOT.TLegend(0.155, 0.58, 0.355, 0.62)
...
textConj = ROOT.TLatex(0.25, 0.31, 'D^{+}#rightarrow #pi^{+}K^{#font[122]{-}}#pi^{+} and c.c.')
textConj.SetNDC()

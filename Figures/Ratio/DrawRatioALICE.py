...
hFrame = canvas.DrawFrame(0, 0, 36, 1, ';#it{p}_{T} (Ge#kern[-0.05]{V}/#it{c});D_{s}^{+}/D^{+}')
...
Thislegend.AddEntry(hRatio, '#sqrt{#it{s}} = 13.6 Te#kern[-0.05]{V}', 'pl')
Thislegend.Draw()
...
ThislegendBorder.AddEntry(hRatioBorder, '#sqrt{#it{s}} = 13.6 Te#kern[-0.05]{V}', 'pl')
...
legend = ROOT.TLegend(0.25, 0.14, 0.45, 0.26)
legend.SetBorderSize(0)
legend.SetTextSize(0.0285)
legend.SetFillStyle(0)
legend.AddEntry(hAlice13Tev, '#sqrt{#it{s}} = 13 Te#kern[-0.1]{V}, JHEP 12 (2023) 086', 'pl')
legend.AddEntry(hAlice7Tev, '#sqrt{#it{s}} = 7 Te#kern[-0.1]{V}, Eur. Phys. J. C 77 (2017) 550', 'pl')
legend.AddEntry(hAlice5Tev, '#sqrt{#it{s}} = 5 Te#kern[-0.1]{V}, JHEP 05 (2021) 220', 'pl')
legend.Draw()

legendBorder = ROOT.TLegend(0.25, 0.14, 0.45, 0.26)
legendBorder.SetBorderSize(0)
legendBorder.SetTextSize(0.0285)
legendBorder.SetFillStyle(0)
legendBorder.AddEntry(hAlice13TevBorder, '#sqrt{#it{s}} = 13 Te#kern[-0.1]{V}', 'pl')
legendBorder.AddEntry(hAlice7TevBorder, '#sqrt{#it{s}} = 7 Te#kern[-0.1]{V}', 'pl')
legendBorder.AddEntry(hAlice5TevBorder, '#sqrt{#it{s}} = 5 Te#kern[-0.1]{V}', 'pl')
legendBorder.Draw()

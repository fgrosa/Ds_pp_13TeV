...
legend.AddEntry(hAlice13Tev, '#sqrt{#it{s}} = 13 Te#kern[-0.1]{V}, JHEP12(2023)086', 'pl')
legend.AddEntry(hAlice7Tev, '#sqrt{#it{s}} = 7 Te#kern[-0.1]{V}, EPJC - s10052-019-6873-6', 'pl')
legend.AddEntry(hAlice5Tev, '#sqrt{#it{s}} = 5 Te#kern[-0.1]{V}, JHEP05(2021)220', 'pl')
legend.Draw()

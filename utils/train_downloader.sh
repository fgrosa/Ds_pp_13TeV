...
IS_SLIM=true
MAX_FILES_TO_DOWNLOAD=60
N_FILES_FOR_MERGE=2
N_JOBS=10
SUFFIX="LHC23_pass4_small"
SELECTIONS="" # Can be null if no selection is needed
TRAIN_FRACTION=1
ISMC=false
MC_SELECTIONS=(
    "PromptDs:fOriginMcRec == 1 and fFlagMcDecayChanRec == 1"
    "NonPromptDs:fOriginMcRec == 2 and fFlagMcDecayChanRec == 1"
    "PromptDplus:fOriginMcRec == 1 and fFlagMcDecayChanRec == 3"
    "NonPromptDplus:fOriginMcRec == 2 and fFlagMcDecayChanRec == 3"
    "NonPrompt:fOriginMcRec == 2 and (fFlagMcDecayChanRec == 3 or fFlagMcDecayChanRec == 1)"

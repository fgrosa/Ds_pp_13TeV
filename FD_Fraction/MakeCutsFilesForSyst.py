...
def make_cuts_ml():
    ...
    step_variation = [{"1": 0.02, "1.5": 0.02, "2": 0.02, "2.5": 0.02, "3": 0.02, "3.5": 0.02, "4": 0.02, "4.5": 0.02, \
                         "5": 0.02, "5.5": 0.02, "6": 0.02, "8": 0.02, "12": 0.02}]
    num_step_pos = 13
    num_step_neg = 0
    edge_to_vary = ['min']

    in_dir = '/home/fchinu/Run3/Ds_pp_13TeV/FD_Fraction/'
    cut_file_central = 'Central_cutset.yml'
    out_dir = '/home/fchinu/Run3/Ds_pp_13TeV/FD_Fraction/configs/'

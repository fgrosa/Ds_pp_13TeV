...
def make_cuts_ml():
    ...
    step_variation = [{"0.5": 0.02, "1.0": 0.02, "1.5": 0.02, "2.0": 0.02, "2.5": 0.02, "3.0": 0.02, "3.5": 0.02, "4.0": 0.05, "4.5": 0.05, \
    ...
    cut_file_central = 'Central_cutsetDplus.yml'
    out_dir = '/home/fchinu/Run3/Ds_pp_13TeV/FD_Fraction/data_driven/Dplus/configs/'
    ...
    for prod_steps in product(steps, repeat=n_combinations):
        ...
        for i, step in enumerate(prod_steps):
            ...
            name = f'_{var_tag[i]}_{step_name}{str(int(step)+15).zfill(2)}'
            file_tag += name

...
// function prototypes
void PlotCutVariationsOnePtBin(TString cfgFileName = "/home/fchinu/Xic0_pPb_5TeV/Dmesoncode/PaperProposal/Systematics/BDT/config_cutvar_Xic0prompt_pPb.yml");
void SetStyle();
